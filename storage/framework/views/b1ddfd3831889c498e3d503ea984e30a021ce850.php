            ...
            <div class="box-body">
              ...
              <?php endif; ?>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="video_id_home" id="video_id_home" value="<?php echo e($settingArr['video_id_home']); ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="7" name="thanks" id="thanks"><?php echo e($settingArr['thanks']); ?></textarea>
                </div>
                <div class="form-group">
