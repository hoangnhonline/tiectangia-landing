...
<div class="wrapper">
  ...
  <?php if(Auth::user()->email != "huongll@tiecngon.vn" && \Request::route()->getName() != "compare.index" ): ?>
...
<input type="hidden" id="url_open_kc_finder" value="<?php echo e(URL::asset('admin/dist/js/kcfinder/browse.php?type=images')); ?>">
