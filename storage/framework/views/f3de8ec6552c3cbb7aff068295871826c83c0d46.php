		...
		<div class="container">			
			<ul class="row product-list">
				...
				<li class="col-md-2 col-sm-4 col-xs-6">
					<div class="icon">
						<a style="height: 100%" href="<?php echo e($articles->url); ?>" title="<?php echo $articles->title; ?>">
			      ...
			      <div class="panel-heading" style="background-color: #252525; color: #FFF; font-weight: bold">
			        ...
			        <ul class="list-group-mon">
					    	<?php foreach($foodType->foodGroup as $group): ?>
					    		...
					    		<li style="display: inline;"><a style="color: #ff6f05;text-transform: lowercase;" href="#mon<?php echo e($group->slug); ?>"><?php echo $group->name; ?></a> // </li>
			      ...
			      <div id="collapse<?php echo $foodType->slug; ?>" class="panel-collapse">
			        <div class="panel-body" style="max-height: 400px;overflow-y: scroll;">
			        	<table class="table table-bordered">
			        		<?php if($foodType->foodGroup->count() > 0): ?>
					    	<?php foreach($foodType->foodGroup as $group): ?>
					    	<tr id="mon<?php echo e($group->slug); ?>" style="color: #000000; font-weight: bold; font-size: 20px; text-transform: uppercase;">
					    		<td colspan="3"><p class="food-group" style="text-align: center;padding-top: 15px;"><?php echo $group->name; ?></p></td>			    	
					    	</tr>
