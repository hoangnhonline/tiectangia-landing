<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview <?php echo e(in_array(\Request::route()->getName(), ['menu.index', 'menu.create', 'menu.edit']) ? 'active' : ''); ?>">
        <a href="#">
        ...
        <ul class="treeview-menu">
          <li <?php echo e(in_array(\Request::route()->getName(), ['menu.index', 'menu.edit']) ? "class=active" : ""); ?>><a href="<?php echo e(route('menu.index')); ?>"><i class="fa fa-circle-o"></i> Menu</a></li>
          <li <?php echo e(in_array(\Request::route()->getName(), ['menu.create']) ? "class=active" : ""); ?>><a href="<?php echo e(route('menu.create')); ?>"><i class="fa fa-circle-o"></i> Thêm Menu</a></li>          
        </ul>
      </li>
      <li class="treeview <?php echo e(in_array(\Request::route()->getName(), ['food.index', 'food.create', 'food.edit']) ? 'active' : ''); ?>">
        <a href="#">
          <i class="fa fa-twitch"></i> 
          <span>Món ăn</span>
          <span class="pull-right-container">
        ...
        <ul class="treeview-menu">
          <li <?php echo e(in_array(\Request::route()->getName(), ['food.index', 'food.edit']) ? "class=active" : ""); ?>><a href="<?php echo e(route('food.index')); ?>"><i class="fa fa-circle-o"></i> Món ăn</a></li>
          <li <?php echo e(in_array(\Request::route()->getName(), ['food.create']) ? "class=active" : ""); ?>><a href="<?php echo e(route('food.create')); ?>"><i class="fa fa-circle-o"></i> Thêm món ăn</a></li>          
        </ul>
      </li>
      <li <?php echo e(in_array(\Request::route()->getName(), ['dat-mon.index']) ? "class=active" : ""); ?>>
        <a href="<?php echo e(route('dat-mon.index')); ?>">
          <i class="fa fa-pencil-square-o"></i> 
          <span>Liên hệ đặt món</span>         
        </a>       
      </li>
      <li class="treeview <?php echo e(in_array(\Request::route()->getName(), ['food-type.index', 'food-type.create', 'food-type.edit']) ? 'active' : ''); ?>">
        <a href="#">
          <i class="fa fa-twitch"></i> 
        ...
        <ul class="treeview-menu">
          <li <?php echo e(in_array(\Request::route()->getName(), ['food-type.index', 'food-type.edit']) ? "class=active" : ""); ?>><a href="<?php echo e(route('food-type.index')); ?>"><i class="fa fa-circle-o"></i>Loại món ăn</a></li>
          <li <?php echo e(in_array(\Request::route()->getName(), ['food-type.create']) ? "class=active" : ""); ?>><a href="<?php echo e(route('food-type.create')); ?>"><i class="fa fa-circle-o"></i> Thêm loại món ăn</a></li>          
        </ul>
      </li>
      <li class="treeview <?php echo e(in_array(\Request::route()->getName(), ['food-group.index', 'food-group.create', 'food-group.edit']) ? 'active' : ''); ?>">
        <a href="#">
          <i class="fa fa-twitch"></i> 
        ...
        <ul class="treeview-menu">
          <li <?php echo e(in_array(\Request::route()->getName(), ['food-group.index', 'food-group.edit']) ? "class=active" : ""); ?>><a href="<?php echo e(route('food-group.index')); ?>"><i class="fa fa-circle-o"></i>Nhóm món ăn</a></li>
          <li <?php echo e(in_array(\Request::route()->getName(), ['food-group.create']) ? "class=active" : ""); ?>><a href="<?php echo e(route('food-group.create')); ?>"><i class="fa fa-circle-o"></i> Thêm nhóm món ăn</a></li>          
        </ul>
      </li>
      ...
      <li class="treeview <?php echo e(in_array(\Request::route()->getName(), ['loai-thuoc-tinh.index', 'thuoc-tinh.index', 'color.index']) ? 'active' : ''); ?>">
        ...
        <ul class="treeview-menu">
          <li <?php echo e(\Request::route()->getName() == "settings.index" ? "class=active" : ""); ?>><a href="<?php echo e(route('settings.index')); ?>"><i class="fa fa-circle-o"></i> Thông tin tiecngon.vn</a></li>
